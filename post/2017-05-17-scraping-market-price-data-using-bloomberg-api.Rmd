---
title: Scraping Market Price Data using Bloomberg API
author: Rey Anthony Masilang
date: '2017-05-17'
slug: scraping-market-price-data-using-bloomberg-api
image: https://raw.githubusercontent.com/r-mas/r-mas.github.io/master/img/banners/scrape_API_banner.png
categories:
  - EDA
  - Finance
  - Data Cleaning
...
require(readr)
uitf_matrix <- read_csv(paste0(datasets_dir, "/", "uitf_matrix_05_07_2017.csv"))
```
...
plot <- price_data %>% 
    ...
    mutate(tooltip = paste(tooltip, 
                           paste0("5Y-Return: ", 
                                 ...
                                 "%"),
                           sep = "\n")) %>% 
    filter(!is.na(`Fund Classification`)) %>% 
